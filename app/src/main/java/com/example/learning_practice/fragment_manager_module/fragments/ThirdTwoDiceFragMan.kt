...
import com.example.learning_practice.databinding.FragmentThirdTwoDiceFragManBinding

class ThirdTwoDiceFragMan : Fragment() {
    private var diceConf: DiceConfiguration = DiceConfiguration()
    private lateinit var binding: FragmentThirdTwoDiceFragManBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_third_two_dice_frag_man,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.diceManImage5.setImageResource(img)
        ...
        binding.diceManImage6.setImageResource(img2)
    }
